...
#---------- Cell Definition -----------------#
CellData = cell("LG_M50") #Alternative "Doyle_94"
...
time = 0:0.25:99.75
CellV, Ce, jNeg, jPos, RtotNeg, RtotPos, η0, ηL, η_neg, η_pos, ϕ_ẽ1, ϕ_ẽ2, Uocp_Neg, Uocp_Pos, ϕ_e, Cse_Neg, Cse_Pos = Sim_Model(CellData,Iapp,Tk,A,B,C,D)
