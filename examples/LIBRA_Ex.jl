...
@inline function DRA_loop(CellData)
    A_DRA = B_DRA = C_DRA = D_DRA = Dtt = tf__ = s = Hank1 = Hank2 = puls = tuple()
        ...
        CellData.Const.κ = CellData.Const.κf(CellData.Const.ce0)*exp(CellData.Const.Ea_κ*Arr_Factor)
            for i in 1:1
                ...
                for SOC in 1.:1.:1.
                    ...
                    A, B, C, D, Dtt, tf__, Hank1, Hank2, puls = DRA(CellData,s,f)
...
return A_DRA, B_DRA, C_DRA, D_DRA, Dtt, tf__, s, Hank1, Hank2, puls
end

#TransferFuns = TransferFun()
#Nfft, f, s = Impulse()
#A_DRA, B_DRA, C_DRA, D_DRA, Dtt = DRA_loop(CellData,s,f)
A_DRA, B_DRA, C_DRA, D_DRA, Dtt, tf__, s, Hank1, Hank2, puls = DRA_loop(CellData)
