...
ax1 = @pgf Axis({
                ...
                Plot({color = κ[10], "thick"},
                     Table([
                               :x => Results[1].t[1:tₑₜ[1]],
                               :y => Results[1].Cell_V[1:tₑₜ[1]],
                           ])), LegendEntry(L"$\theta_n^0$ = 0.95"),
                Plot({color = κ[7], "thick"},
                     Table([
                               :x => Results[2].t[1:tₑₜ[2]],
                               :y => Results[2].Cell_V[1:tₑₜ[2]],
                           ])), LegendEntry(L"$\theta_n^0$ = 0.85"),
                Plot({color = κ[8], "thick"},
                     Table([
                               :x => Results[3].t[1:tₑₜ[3]],
                               :y => Results[3].Cell_V[1:tₑₜ[3]],
...
ax3 = @pgf Axis({
                ...
                Plot({color = κ[10], "thick"},
                     Table([
                               :x => Results[1].t[1:tₑₜ[1]],
                               :y => Results[1].Cseₚ[1:tₑₜ[1]],
                           ])),
                Plot({color = κ[7], "thick"},
                     Table([
                               :x => Results[2].t[1:tₑₜ[2]],
                               :y => Results[2].Cseₚ[1:tₑₜ[2]],
                           ])),
                Plot({color = κ[8], "thick"},
                     Table([
                               :x => Results[3].t[1:tₑₜ[3]],
                               :y => Results[3].Cseₚ[1:tₑₜ[3]],
                           ])))
...
ax4 = @pgf Axis({
                ...
                Plot({color = κ[10], "thick"},
                     Table([
                               :x => Results[1].t[1:tₑₜ[1]],
                               :y => Results[1].Cseₙ[1:tₑₜ[1]],
                           ])),
                Plot({color = κ[7], "thick"},
                     Table([
                               :x => Results[2].t[1:tₑₜ[2]],
                               :y => Results[2].Cseₙ[1:tₑₜ[2]],
                           ])),
                Plot({color = κ[8], "thick"},
                     Table([
                               :x => Results[3].t[1:tₑₜ[3]],
                               :y => Results[3].Cseₙ[1:tₑₜ[3]],
                           ])))

@pgf GroupPlot({
                group_style = {group_size = "2 by 2", horizontal_sep = "2cm",
                               vertical_sep = "1.5cm"},
                no_markers,
