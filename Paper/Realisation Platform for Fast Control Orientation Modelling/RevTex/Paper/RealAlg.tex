...
\title{Realisation Platform for \\ Fast Control Orientation Modelling}% Force line breaks with \\
...
\affiliation{%
 ...
 School of Engineering, Mathematics, and Computing
}%
...
\bibliography{RealAlg}% Produces the bibliography via BibTeX.
