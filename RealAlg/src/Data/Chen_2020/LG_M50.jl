...
@with_kw mutable struct Constants
    ...
    ∂Uocp::Function = (Electrode,θ) -> 
        if Electrode == "Neg"
            ∂Uocp = 1.9793*ℯ^(-39.3631*θ)+0.2482-0.0909*tanh(29.8538*(θ-0.1234))-0.04478*tanh(14.9159*(θ-0.2769))-0.0205*tanh(30.4444*(θ-0.6103))
        else
            ∂Uocp = -0.809*θ+4.4875-0.0428*tanh(18.513*(θ-0.5542))-17.7326*tanh(15.7890*(θ-0.3117))+17.5842*tanh(15.9308*(θ-0.6103))
        end
end
